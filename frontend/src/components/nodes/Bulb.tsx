...
const Bulb = ({
  ...
  const bulbOn = activeNodes.includes(id);
  ...
  const toggleBulb = () => {
    ...
    const newActiveNodes = simulate(nodes, edges).active_nodes;
